...
local outcsv "SI_results/TableS6.csv"
local outmd "SI_results/S_TableS6.md"
...
forvalues i = 1/`model_count' {
    ...
    quietly reghdfe `y' i.Grade_10##i.Climate `controls', absorb(month) cluster(`worker_fe') resid
